...
| 平台 | 檔案 | 大小 | 直連 |
|------|------|------|------|
| **macOS Apple Silicon** | `OpenWorker-macos-arm64.dmg` | 66 MB | [下載](https://github.com/PurryTam/openworker-chinese/releases/download/v0.1.7/OpenWorker-macos-arm64.dmg) |
| **Windows x64 (NSIS 安裝程式)** | `OpenWorker-windows-setup.exe` | 57 MB | [下載](https://github.com/PurryTam/openworker-chinese/releases/download/v0.1.7/OpenWorker-windows-setup.exe) |
| **Windows x64 (MSI)** | `OpenWorker-windows.msi` | 68 MB | [下載](https://github.com/PurryTam/openworker-chinese/releases/download/v0.1.7/OpenWorker-windows.msi) |
| **Linux x64 (AppImage)** | `OpenWorker-linux-x64.AppImage` | 155 MB | [下載](https://github.com/PurryTam/openworker-chinese/releases/download/v0.1.7/OpenWorker-linux-x64.AppImage) |
| **Linux x64 (deb)** | `OpenWorker-linux-x64.deb` | 91 MB | [下載](https://github.com/PurryTam/openworker-chinese/releases/download/v0.1.7/OpenWorker-linux-x64.deb) |
