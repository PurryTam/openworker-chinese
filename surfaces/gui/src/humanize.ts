...
export function humanizeTool(name: string, args: any): HumanLine {
  ...
  switch (name) {
    ...
    case "read_file":
      return { pre: t("Read "), obj: baseName(String(a.path ?? "a file")) };
    case "write_file":
      return { pre: t("Wrote "), obj: baseName(String(a.path ?? "a file")) };
    case "replace_in_file":
    case "apply_patch":
    case "apply_unified_diff":
      return { pre: t("Edited "), obj: a.path ? baseName(String(a.path)) : "files" };
    case "grep":
    ...
    case "todo_write": {
      ...
      return { pre: t("Updated the plan — {{n}} items", { n: items.length }) };
    }
    case "send_message": {
    ...
    default: {
      ...
      return { pre: t("Used {{name}}", { name }), ...(rest ? { post: ` — ${rest}` } : {}) };
    }
  }
}
...
export function humanizeApprovalTitle(name: string, args: any): HumanLine {
  ...
  switch (name) {
    case "write_file":
      return { pre: t("Write "), obj: baseName(String(a.path ?? "a file")) };
    case "replace_in_file":
    case "apply_patch":
    case "apply_unified_diff":
      return { pre: t("Edit "), obj: a.path ? baseName(String(a.path)) : "files" };
    case "run_shell": {
      const desc = typeof a.description === "string" && a.description.trim() ? a.description.trim() : "";
      return {
        pre: t("Run a command"),
...
export function humanizeAsk(name: string, args: any): HumanLine {
  ...
  switch (name) {
    ...
    case "write_file":
      return { pre: t("Wanted to write "), obj: baseName(String(a.path ?? "a file")) };
    case "replace_in_file":
    case "apply_patch":
    case "apply_unified_diff":
      return { pre: t("Wanted to edit "), obj: a.path ? baseName(String(a.path)) : "files" };
    case "send_message": {
      const { platform, tail } = messageTarget(String(a.target ?? ""));
