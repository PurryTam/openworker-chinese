...
import { setLangPref, type Lang } from "../i18n";
...
function VoiceInputSection() {
  ...
  return (
    <section>
      ...
      {!desktop ? (
        <div className={CARD + " p-4 text-[13px] text-muted"}>{t("Voice Input setup is available in the OpenWorker desktop app.")}</div>
      ) : (
        <div className="space-y-4">
          ...
          <div className={CARD}>
            ...
            <div className="border-t border-line bg-paper/50 px-4 py-3 grid grid-cols-2 gap-3 text-[12px] text-muted">
              ...
              <div><span className="block text-ink font-medium">{t("Memory")}</span>8 GB recommended</div>
              <div><span className="block text-ink font-medium">{t("Processor")}</span>4 CPU cores recommended</div>
            </div>
          </div>
  ...
  return (
    <section>
      ...
      <div className={CARD + " p-4 mb-4"}>
        ...
        <div className={FIELD_HELP}>{t("Switch the interface language. Changes apply instantly.")}</div>
      </div>
        ...
        <div className={CARD + " p-4"}>
          ...
          <label className="flex items-start gap-3 py-2">
            ...
            <span>
              ...
              <span className="block text-[12px] text-muted">{t("Launch OpenWorker automatically when you sign in.")}</span>
            </span>
          </label>
          <label className="flex items-start gap-3 py-2">
        ...
        <span className="text-[12px] text-muted">
          {state === "none"
            ...
            : state === "error"
              ...
              : t("Downloading — OpenWorker restarts by itself when it's ready.")}
        </span>
      )}
    </span>
  );
