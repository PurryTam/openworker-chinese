  ...
  return (
    <section>
      ...
      <div className={CARD + " p-4 mb-4"}>
        ...
        <div className={FIELD_HELP}>Auto follows your Mac's appearance.</div>
      </div>
  ...
  return (
    <div className={CARD + " p-4 mb-4"} data-testid="token-savings-card">
      ...
      <div className={FIELD_HELP}>
        ...
        don't (GLM, Kimi, DeepSeek, local models…). Text extraction is cheapest; page
      ...
      <div className={FIELD_HELP}>
        PDFs over these limits are not attached — you'll see a notice in the composer
        instead.
      </div>
    </div>
  );
